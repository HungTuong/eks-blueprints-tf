    ...
    "widgets": [
        {
            ...
            "type": "log",
            "properties": {
                "query": "SOURCE '${aws_cloudwatch_log_group.aws_waf_log.name}' | fields httpRequest.country\n| stats count(*) as requestCount by httpRequest.country\n| sort requestCount desc\n| limit 100",
                "region": "${local.region}",
                "stacked": false,
                "view": "pie",
        ...
        },
        {
            ...
            "type": "log",
            "properties": {
                "query": "SOURCE '${aws_cloudwatch_log_group.aws_waf_log.name}' | fields httpRequest.clientIp\n| stats count(*) as requestCount by httpRequest.clientIp\n| sort requestCount desc\n| limit 10",
                "region": "${local.region}",
                "stacked": false,
                "view": "table",
        ...
        },
        {
            ...
            "type": "log",
            "properties": {
                "query": "SOURCE '${aws_cloudwatch_log_group.aws_waf_log.name}' | fields terminatingRuleId\n| stats count(*) as requestCount by terminatingRuleId\n| sort requestCount desc\n| limit 10",
                "region": "${local.region}",
                "stacked": false,
                "view": "table",
        ...
        },
        {
            ...
            "type": "log",
            "properties": {
                "query": "SOURCE '${aws_cloudwatch_log_group.aws_waf_log.name}' | fields httpRequest.uri\n| stats count(*) as requestCount by httpRequest.uri\n| sort requestCount desc\n| limit 20",
                "region": "${local.region}",
                "stacked": false,
                "view": "table",
                "title": "Top 20 URI"
        ...
        },
        {
            ...
            "type": "log",
            "properties": {
                "query": "SOURCE '${aws_cloudwatch_log_group.aws_waf_log.name}' | fields action, ruleGroupList.0.excludedRules.0.exclusionType\n| stats count(*) as requestCount by action, ruleGroupList.0.excludedRules.0.exclusionType\n| sort requestCount desc\n| limit 100",
                "region": "${local.region}",
                "stacked": false,
                "title": "Allowed vs Blocked Requests",
                "view": "bar"
        ...
        },
        {
            ...
            "type": "log",
            "properties": {
                "query": "SOURCE '${aws_cloudwatch_log_group.aws_waf_log.name}' | fields @action\n| stats count(*) as requestCount",
                "region": "${local.region}",
                "stacked": false,
                "title": "All Requests",
                "view": "table"
        ...
        },
        {
            ...
            "type": "log",
            "properties": {
                "query": "SOURCE '${aws_cloudwatch_log_group.aws_waf_log.name}' | fields @httpRequest.httpMethod\n| stats count(*) as httpMethod by httpRequest.httpMethod\n| sort requestCount desc",
                "region": "${local.region}",
                "stacked": false,
                "view": "pie",
                "title": "HTTP Methods"
        ...
        },
        {
            ...
            "type": "log",
            "properties": {
                "query": "SOURCE '${aws_cloudwatch_log_group.aws_waf_log.name}' | fields action, ruleGroupList.0.terminatingRule.ruleId, ruleGroupList.1.terminatingRule.ruleId, ruleGroupList.2.terminatingRule.ruleId, ruleGroupList.3.terminatingRule.ruleId\n| filter action=\"BLOCK\"\n| sort @timestamp desc",
                "region": "${local.region}",
                "stacked": false,
                "view": "table",
        ...
        },
        {
            ...
            "type": "log",
            "properties": {
                "query": "SOURCE '${aws_cloudwatch_log_group.aws_waf_log.name}' | fields @timestamp, action as WAF_ACTION, httpRequest.uri as uri, httpRequest.country as country\n| parse @message '{\"name\":\"Host\",\"value\":\"*\"}' as host\n| parse @message '{\"exclusionType\":\"EXCLUDED_AS_COUNT\",\"ruleId\":\"*\"}' as EXCLUDED_AS_COUNT_RuleId\n| filter ispresent(EXCLUDED_AS_COUNT_RuleId)\n| limit 100",
                "region": "${local.region}",
                "stacked": false,
